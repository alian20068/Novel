package com.newjoin.novel.Views;
...
public class BottomBarView extends View {
    ...
    protected void switchFragment(int whichFragment) {
        ...
        //Log.d("BottomBarView","切换"+whichFragment);
        ...
        if (fragment != null) {
            ...
            if (fragment.isAdded()) {
                ...
                Log.d("BottomBarView","已添加 切换"+whichFragment);

                if (currentFragment != null) {
                    transaction.hide(currentFragment).show(fragment);
                    //transaction.remove(currentFragment).show(fragment);
                } else {
                    transaction.show(fragment);
                }
            } else {

                Log.d("BottomBarView","未添加 切换"+whichFragment);

                if (currentFragment != null) {
                    transaction.hide(currentFragment).add(frameLayoutId, fragment);
                    //transaction.remove(currentFragment).add(frameLayoutId, fragment);
                } else {
